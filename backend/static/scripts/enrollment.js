...
<div class="course-div-header"><div class="course-enrolled">Enrolled</div><div><img src="/static/images/delete.png" class="remove-course-button" onclick="removeCourse(this)"></div></div><h2>${course["subject"]} ${course["course_level"]}</h2>` : `<div class="course-div-header"><h2>${course["subject"]} ${course["course_level"]}</h2><div><img src="/static/images/delete.png" class="remove-course-button" onclick="removeCourse(this)"></div></div>`}<h3>${course["name"]}</h3><h4>Credits: ${course["credits"]}</h4><p>Description: ${course["description"]}</p>
